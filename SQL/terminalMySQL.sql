...
--------------------------------------------------------------------------
DELETE --Utilizado para deletar dados de uma tabela
DELETE FROM usuarios -- Deleta toda a tabela usuarios
DELETE FROM usuarios WHERE idade = 8 -- Deleta todos os registros das linhas que tem valor 8 na coluna idade
UPDATE -- Usado para atualizar registros na tabela
UPDATE usuarios SET nome = "Nome de Teste" -- Altera todos os nomes da tabela usuarios para "Nome de Teste"
UPDATE usuarios SET nome = "Nome de Teste" WHERE nome = "Augusto Oliveira" -- Altera o nome atual com valor Augusto Oliveira para "Nome de Teste"